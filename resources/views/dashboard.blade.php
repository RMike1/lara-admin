      ...
      <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white dark:bg-gray-700 divide-y divide-gray-200">
          ...
          <tr>
            ...
            <button Styles="s"><a href="#" class="m-2 p-2 bg-green-400 rounded">View</a></button>
            <button Styles="s"><a href="#" class="m-2 p-2 bg-green-400 rounded">Edit</a></button>
            <button Styles="s"><a href="#" class="m-2 p-2 bg-green-400 rounded">Delete</a></button>
